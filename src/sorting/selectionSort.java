...
public class selectionSort {
	...
	public static void sort(int[] a){
		...
		for(int i=0; i<N; i++){
			int min=i;
			for(int j=i+1; j<N; j++){
				if (comunFunctions.less(a[j], a[min])) min=j;
			}	
			comunFunctions.switchValues(a, i, min);	
		}
	}
	
	public static void main(String args[]) throws IOException{
		
		System.out.println("Starting Selection Short Algorithm");
		comunFunctions.addToFile("/Users/sergio_pn_21/Documents/workspace/Algorithms/results.txt","Starting Selection Sort Algorithm\n");
