...
public class combSort {
	...
	public static void sort(int[] a){
         ...
         while (1 < gap || swapped) {
	        ...
	        for (int i = 0; gap + i < a.length; i++) {
	            if (comunFunctions.less(a[i+gap], a[i])) {
	                comunFunctions.switchValues(a, i, i + gap);
	                swapped = true;
	            }
	        }
	    }
	...
	public static void main(String args[]) throws IOException{
		...
		System.out.println("Starting Bubble Short Algorithm");	
		comunFunctions.addToFile("/Users/sergio_pn_21/Documents/workspace/Algorithms/results.txt","Starting Comb Sort Algorithm\n");
