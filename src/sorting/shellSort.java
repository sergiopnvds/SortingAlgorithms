...
public class shellSort {
	...
	public static void sort(int[] a){
		...
		while(h >= 1){
			for(int i=h; i<N; i++){
				for(int j=i; j>=h && comunFunctions.less(a[j], a[j-h]); j-=h)	
					comunFunctions.switchValues(a, j, j-h);	
			}
			h=h/3;
		}
	}
	...
	public static void main(String args[]) throws IOException{
		...
		System.out.println("Starting Shell Short Algorithm");
		comunFunctions.addToFile("/Users/sergio_pn_21/Documents/workspace/Algorithms/results.txt","Starting Shell Sort Algorithm\n");
